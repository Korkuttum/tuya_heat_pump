...
SENSOR_TYPES = {
    ...
    # --- moved from NUMBER_TYPES (2026-07-29): these are read-only
    # live metrics reported BY the unit, not settable values — per
    # @simonboerstra's CSV feedback they showed up as adjustable
    # number entities, which was wrong. Confirmed safe to move
    # (no encoding/options question here, just entity type). ---
